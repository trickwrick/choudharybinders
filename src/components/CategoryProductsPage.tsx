                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <label className="flex items-center gap-2 text-sm text-text/70">
                    ...
                    <select
                      ...
                      className="rounded-lg border border-border bg-white px-3 py-2 text-sm text-text outline-none transition-colors focus:ring-1 focus:ring-primary focus:border-primary"
                    >
